...
CREATE TABLE layers.countries_fixed (
    fid          BIGINT NOT NULL,
    ...
    "BRK_DIFF"   INTEGER,
    "NAME"       VARCHAR(29),
    "NAME_LONG"  VARCHAR(36),
    "BRK_A3"     VARCHAR(3),
    "BRK_NAME"   VARCHAR(32),
    "BRK_GROUP"  VARCHAR(17),
    "ABBREV"     VARCHAR(16),
    "POSTAL"     VARCHAR(4),
    "FORMAL_EN"  VARCHAR(52),
    "FORMAL_FR"  VARCHAR(35),
    "NAME_CIAWF" VARCHAR(45),
    "NOTE_ADM0"  VARCHAR(16),
    "NOTE_BRK"   VARCHAR(63),
    ...
    "WOE_ID"     INTEGER,
    "WOE_ID_EH"  INTEGER,
    "WOE_NOTE"   VARCHAR(167),
    "ADM0_ISO"   VARCHAR(3),
    "ADM0_DIFF"  VARCHAR(1),
    "ADM0_TLC"   VARCHAR(3),
    "ADM0_A3_US" VARCHAR(3),
    "ADM0_A3_FR" VARCHAR(3),
    "ADM0_A3_RU" VARCHAR(3),
    "ADM0_A3_ES" VARCHAR(3),
    "ADM0_A3_CN" VARCHAR(3),
    "ADM0_A3_TW" VARCHAR(3),
    "ADM0_A3_IN" VARCHAR(3),
    "ADM0_A3_NP" VARCHAR(3),
    "ADM0_A3_PK" VARCHAR(3),
    "ADM0_A3_DE" VARCHAR(3),
    "ADM0_A3_GB" VARCHAR(3),
    "ADM0_A3_BR" VARCHAR(3),
    "ADM0_A3_IL" VARCHAR(3),
    "ADM0_A3_PS" VARCHAR(3),
    "ADM0_A3_SA" VARCHAR(3),
    "ADM0_A3_EG" VARCHAR(3),
    "ADM0_A3_MA" VARCHAR(3),
    "ADM0_A3_PT" VARCHAR(3),
    "ADM0_A3_AR" VARCHAR(3),
    "ADM0_A3_JP" VARCHAR(3),
    "ADM0_A3_KO" VARCHAR(3),
    "ADM0_A3_VN" VARCHAR(3),
    "ADM0_A3_TR" VARCHAR(3),
    "ADM0_A3_ID" VARCHAR(3),
    "ADM0_A3_PL" VARCHAR(3),
    "ADM0_A3_GR" VARCHAR(3),
    "ADM0_A3_IT" VARCHAR(3),
    "ADM0_A3_NL" VARCHAR(3),
    "ADM0_A3_SE" VARCHAR(3),
    "ADM0_A3_BD" VARCHAR(3),
    "ADM0_A3_UA" VARCHAR(3),
    "ADM0_A3_UN" INTEGER,
    "ADM0_A3_WB" INTEGER,
    "CONTINENT"  VARCHAR(23),
    "REGION_UN"  VARCHAR(10),
    ...
    "NAME_ZH"    VARCHAR(33),
    "NAME_ZHT"   VARCHAR(33),
    "FCLASS_ISO" VARCHAR(24),
    "TLC_DIFF"   VARCHAR(1),
    "FCLASS_TLC" VARCHAR(21),
    "FCLASS_US"  VARCHAR(30),
    "FCLASS_FR"  VARCHAR(18),
    "FCLASS_RU"  VARCHAR(14),
    "FCLASS_ES"  VARCHAR(18),
    "FCLASS_CN"  VARCHAR(24),
    "FCLASS_TW"  VARCHAR(15),
    "FCLASS_IN"  VARCHAR(14),
    "FCLASS_NP"  VARCHAR(24),
    "FCLASS_PK"  VARCHAR(15),
    "FCLASS_DE"  VARCHAR(18),
    "FCLASS_GB"  VARCHAR(18),
    "FCLASS_BR"  VARCHAR(12),
    "FCLASS_IL"  VARCHAR(15),
    "FCLASS_PS"  VARCHAR(15),
    "FCLASS_SA"  VARCHAR(15),
    "FCLASS_EG"  VARCHAR(24),
    "FCLASS_MA"  VARCHAR(24),
    "FCLASS_PT"  VARCHAR(18),
    "FCLASS_AR"  VARCHAR(12),
    "FCLASS_JP"  VARCHAR(18),
    "FCLASS_KO"  VARCHAR(18),
    "FCLASS_VN"  VARCHAR(12),
    "FCLASS_TR"  VARCHAR(18),
    "FCLASS_ID"  VARCHAR(24),
    "FCLASS_PL"  VARCHAR(18),
    "FCLASS_GR"  VARCHAR(18),
    "FCLASS_IT"  VARCHAR(18),
    "FCLASS_NL"  VARCHAR(18),
    "FCLASS_SE"  VARCHAR(18),
    "FCLASS_BD"  VARCHAR(24),
    "FCLASS_UA"  VARCHAR(18),
